...
import { ChevronDown, Plus, Check, Trash2, Sparkles, X } from 'lucide-react';
      ...
      >
        <div className="workspace-pill-left">
          ...
          <div className="workspace-pill-info">
            <span className="workspace-pill-name">{activeWorkspace?.name || 'Personal'}</span>
            <span className="workspace-pill-sub">Persona Workspace</span>
          </div>
        </div>
      ...
      {isOpen && (
        <>
          ...
          <div className="workspace-dropdown-menu">
            ...
            >
              <Plus size={14} />
              <span>New Persona / Workspace</span>
            </button>
          </div>
        </>
      )}
      ...
      {isModalOpen && (
        <div className="modal-overlay" onClick={() => setIsModalOpen(false)}>
          <div className="modal-card" style={{ maxWidth: '440px' }} onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={handleCreate} className="modal-body" style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
              <div>
